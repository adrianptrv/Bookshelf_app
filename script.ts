...
class Book {
    ...
    add() {
        ...
        newBook.classList.add("odd:bg-white", "even:bg-gray-50", "border-b");
        newBook.innerHTML = '<th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">' + this.name + '</th><td class="px-6 py-4">' + this.author + '</td><td class="px-6 py-4">' + this.category + '</td><td class="px-6 py-4">' + this.year + '</td><td class="px-6 py-4">' + this.read + '</td><td class="px-6 py-4">' + this.isbn + '</td>' + '<td class="px-6 py-4"><a href="#" class="font-medium text-blue-600 hover:underline cursor-pointer" onclick="delBook(this)">Remove</a></td>';
